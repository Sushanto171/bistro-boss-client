...
const Navbar = () => {
  ...
  return (
    <nav className="navbar fixed z-10 bg-black/20 text-white backdrop-blur max-w-screen-lg ">
      <div className="flex-1 font-Cinzel">
      ...
      <div>
        <ul className="uppercase flex gap-3 items-center">{navOptions}</ul>
      </div>
      {user && (
